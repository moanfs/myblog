                ...
                <header class="mb-4 lg:mb-6 not-format">
                    <!-- <address class="flex items-center mb-6 not-italic">
                        <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                            <img class="mr-4 w-16 h-16 rounded-full" src="{{$post->author->photo_url}}" alt="Jese Leos">
                            <div>
                                <a href="#" rel="author" class="text-xl font-bold text-gray-900 dark:text-white">{{$post->author->name}}</a>
                                <p class="text-base font-light text-gray-500 dark:text-gray-400">{!!$post->author->bio!!}</p>
                                <p class="text-base font-light text-gray-500 dark:text-gray-400"><time pubdate datetime="{{$post->created_at->format('Y-m-d')}}" title="{{$post->created_at->format('D. m, Y')}}">{{$post->created_at->format('D. m, Y')}}</time></p>
                            </div>
                        </div>
                    </address> -->
                    ...
                    <script>
                        ...
                        */
                        (function() { // DON'T EDIT BELOW THIS LINE
                            ...
                            s.src = 'https://blog-moan.disqus.com/embed.js';
    ...
    <footer class="bg-gray-50 dark:bg-gray-800">
        <div class="p-4 py-6 mx-auto max-w-screen-xl md:p-8 lg:p-10">
            ...
            <div class="text-center">
                <span class="block text-sm text-center text-gray-500 dark:text-gray-400">© 2023 <a href="https://moanfs.com/" class="hover:underline">moanfs</a>. All Rights Reserved.
                </span>
                <ul class="flex justify-center mt-5 space-x-5">
                    <li>
                        <a href="https://www.instagram.com/moan.fs/" class="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
                    ...
                    <li>
                        <a href="https://github.com/moanfs" class="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    <li>
                        <a href="https://dribbble.com/moanfs" class="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
